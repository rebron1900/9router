...
- **Docker-релизы форка** — Образы AMD64 (`linux/amd64`) публикуются в [GHCR](https://github.com/rebron1900/9router/pkgs/container/9router); каждый релиз обновляет тег версии и `latest`.
