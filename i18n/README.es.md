...
- **Releases Docker del fork** — Las imágenes AMD64 (`linux/amd64`) se publican en [GHCR](https://github.com/rebron1900/9router/pkgs/container/9router); cada release actualiza tanto la etiqueta de versión como `latest`.
