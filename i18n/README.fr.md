...
- **Releases Docker du fork** — Des images AMD64 (`linux/amd64`) sont publiées sur [GHCR](https://github.com/rebron1900/9router/pkgs/container/9router) ; chaque release met à jour le tag de version et `latest`.
