...
- **Releases Docker do fork** — Imagens AMD64 (`linux/amd64`) são publicadas no [GHCR](https://github.com/rebron1900/9router/pkgs/container/9router); cada release atualiza a tag da versão e `latest`.
